CREATE USER IF NOT EXISTS  'dwec'@'localhost' IDENTIFIED BY 'dwec';

GRANT USAGE ON * . * TO 'dwec'@'localhost' IDENTIFIED BY 'dwec' WITH MAX_QUERIES_PER_HOUR 0 MAX_CONNECTIONS_PER_HOUR 0 MAX_UPDATES_PER_HOUR 0 MAX_USER_CONNECTIONS 0 ;

CREATE DATABASE IF NOT EXISTS `dwec_examenes` ;

GRANT ALL PRIVILEGES ON `dwec_examenes` . * TO 'dwec'@'localhost';
